...
(* OASIS_START *)
(* DO NOT EDIT (digest: 29a51d67ae3c72f3cb7a61850e456766) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ...
          ("dispatch_js",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "js"})
       ];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the Javascript dispatch library";
                      flag_default =
                        [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Dispatch_js"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "dispatch";
                        ...
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "docs",
                                OASISExpr.EFlag "js_of_ocaml"),
                             true)
                        ];
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "Dispatch.js docs";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/inhabitedtype/ocaml-dispatch.git";
                      src_repo_browser =
                        Some
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\133\165!v\151\1486\249\196y8.W\199\168\195";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
